...
class TravelNoticeSpider3(scrapy.Spider):
    name = "travelnotice3"
    ...
    def parse(self, response):
        ...
        for text in response.xpath("//h4[@class='notice-typename notice-typename-warning']/text()"):
            d = text.extract()
            alert_measure[country] = d
        with open('travelalert_level3.json', 'w') as outfile:
