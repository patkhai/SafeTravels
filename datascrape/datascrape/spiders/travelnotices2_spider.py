...
class TravelNoticeSpider2(scrapy.Spider):
    name = "travelnotice2"
    ...
    def parse(self, response):
        ...
        for text in response.xpath("//h4[@class='notice-typename notice-typename-alert']/text()"):
            d = text.extract()
            alert_measure[country] = d
        with open('travelalert_level2.json', 'w') as outfile:
